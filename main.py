...
def main():
    ...
    computer_id = ResaleShop.buy(inventory,computer)
    print("Done.\n")

    # Make sure it worked by checking inventory
    print("Checking inventory...")
    ResaleShop.print_inventory(inventory)
    print("Done.\n")
    ...
    ResaleShop.refurbish(inventory,computer_id, new_OS)
    print("Done.\n")
    ...
    ResaleShop.sell(inventory,computer_id)
    ...
    print("Updating inventory...")
    ResaleShop.refurbish(inventory,99, new_OS)
    print("Done.\n")
    #for sell
    print("Selling Item ID:", 99)
    ResaleShop.sell(inventory, 99)
